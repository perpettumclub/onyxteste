            ...
            <div className="relative">
              ...
              {isGroupDropdownOpen && (
                <>
                  ...
                  <div className="absolute bottom-full left-0 mb-1 w-48 premium-card rounded-lg shadow-premium-xl z-20 py-1 animate-in fade-in zoom-in-95 duration-150">
                    {[
            ...
            <div className="relative">
              ...
              {isColumnsDropdownOpen && (
                <>
                  ...
                  <div className="absolute bottom-full left-0 mb-1 w-48 premium-card rounded-lg shadow-premium-xl z-20 py-2 px-3 animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="relative">
              ...
              {isFilterOpen && (
                <>
                  ...
                  <div className="absolute bottom-full right-0 mb-1 w-72 premium-card rounded-xl shadow-premium-xl z-20 p-4 space-y-4 animate-in fade-in zoom-in-95 duration-150">
                    <div>
            ...
            <div className="relative">
              ...
              {isAssigneeDropdownOpen && (
                <>
                  ...
                  <div className="absolute bottom-full right-0 mb-1 w-48 premium-card rounded-lg shadow-premium-xl z-20 py-1 animate-in fade-in zoom-in-95 duration-150">
                    <button
